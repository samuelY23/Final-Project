...
val add: int -> t -> t
(** [add amt acc] is the account returned after [amt] has been added to the account*)
val deduct: int -> t ->t
(** [deduct amt acc] is the account returned after [amt] has been deducted to the account. Requires [amt] is lesser than the amount in the account. Raises [Insufficient Funds] if it is not greater than or equal to.*)
